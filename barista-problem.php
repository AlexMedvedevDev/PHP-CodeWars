...
// function barista($coffees){
//     if (empty($coffees)) return 0;
//     sort($coffees);
//     $wait_time[0] = $coffees[0];
//     for ($i=1;$i<count($coffees);$i++)
//        $wait_time[] = $wait_time[$i-1]+2+$coffees[$i];
//     return array_sum($wait_time);
// }

// function barista($coffees){
//     rsort($coffees);
//     return array_reduce(array_keys($coffees), fn($c, $k) => $c + ($k+1)*$coffees[$k], 0) + count($coffees)*(count($coffees)-1);
// }