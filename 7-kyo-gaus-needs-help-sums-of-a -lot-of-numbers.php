INSTRUCTIONS
him the problem of adding up all the whole numbers from 1 through a given number n.
...
Note: the goal of this kata is to invite you to think about some 
'basic' mathematic formula and how you can do performance optimization on your code. 
...
// function f($n = null) {
//     return (!is_int($n) || $n < 1 || !$n) ? false : ($n / 2) * ($n + 1);
// }
