...
Salesman
Class Constructor
The class constructor of the Salesman class should accept exactly two arguments in the following order: $name, $age. It should then set the correct properties accordingly. 
As for the $occupation of a Salesman, it will always be "Salesman" without exception.
introduce (Method)
...
ComputerProgrammer
Class Constructor
The class constructor of ComputerProgrammer should accept exactly 2 arguments in the following order: $name, $age and should set the correct properties accordingly. 
The $occupation of a ComputerProgrammer is always "Computer Programmer" without exception.
describe_job (Method)
...
WebDeveloper
Class Constructor
The class constructor of this class should receive two arguments in the following order: $name, $age and set the correct properties accordingly. 
The $occupation of a WebDeveloper is always "Web Developer" without exception.
Hint: You may have to add a line of code in the constructor of this class to override the constructor of the parent class.
describe_job (Method)
The describe_job method of a WebDeveloper should return a string of the format:
"I am currently working as a(n) OCCUPATION_HERE, don't forget to check out my Codewars account ;) And don't forget to check on my website :D"
Hint: The same method of the parent class returns a substring of what this method should return.
...
SOLUTIONS
<?php
// I`ve passed test, but there are two issues when I press 'Attempt' button. I have to fix them later
