...
function clonewars(int $kata_per_day): array {
    return [ceil(2**($kata_per_day - 1)), 2 **  ($kata_per_day + 1) - $kata_per_day - 2];
}

// function clonewars(int $kata_per_day): array {
//     $totalKata = 0;
//     $numClones = 1;  
//     for($smart = $kata_per_day; $smart > 0; $smart--) {
//       // do kata
//       $totalKata += $numClones * $smart;
//       // make clones
//       $numClones *= 2;
//       // sleep
//     }
    
//     return array(ceil($numClones / 2), $totalKata);
// }